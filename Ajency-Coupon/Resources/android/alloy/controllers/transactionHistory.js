...
function Controller() {
    ...
    this.__controllerPath = "transactionHistory";
    if (arguments[0]) {
        {
    ...
    var exports = {};
    var __defers = {};
    $.__views.transactionHistory = Ti.UI.createView({
        id: "transactionHistory"
    });
    $.__views.transactionHistory && $.addTopLevelView($.__views.transactionHistory);
    ...
    $.__views.transactionHistory.add($.__views.mainView);
    ...
    $.__views.transactionHistory.add($.__views.stickyFooter);
    ...
    $.__views.stickyFooter.add($.__views.__alloyId38);
    ...
    $.__views.stickyFooter.add($.__views.__alloyId39);
    ...
    var sortTransactions = function(period) {
        ...
        } else alert("No records to fetch");
    };
    $.lbl_week.setColor("#F0C60A");
