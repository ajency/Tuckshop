...
function Controller() {
        ...
        if (result.isValidRow()) {
            ...
            switch (totalUsers) {
              ...
              case 1:
                ...
                } else localStorage.getLastLoggedInUserId() || $.win1.open();
                break;
    ...
    $.__views.index.add($.__views.__alloyId50);
    ...
    $.__views.__alloyId51.add($.__views.companyLogo);
    ...
    $.__views.__alloyId51.add($.__views.usernameTextfield);
    ...
    $.__views.__alloyId51.add($.__views.passwordTextfield);
    ...
    $.__views.__alloyId51.add($.__views.animateObject);
    ...
    $.__views.__alloyId51.add($.__views.errorLabel);
    ...
    $.__views.__alloyId51.add($.__views.loginButton);
    ...
    $.__views.__alloyId51.add($.__views.registerButton);
    ...
    $.__views.index.add($.__views.__alloyId52);
