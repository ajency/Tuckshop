(function(definition) {
    ...
    function deprecate(callback, name, alternative) {
        return function() {
            "undefined" != typeof console && "function" == typeof console.warn && console.warn(name + " is deprecated, use " + alternative + " instead.", new Error("").stack);
    ...
    function trackRejection(promise, reason) {
        ...
        reason && "undefined" != typeof reason.stack ? unhandledReasons.push(reason.stack) : unhandledReasons.push("(no stack) " + reason);
    }
