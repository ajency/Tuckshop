...
//Rare exceptions to indicate a bug in the _boutiquealloy code (Eg, function that a subclass should have implemented)
...
/**
 The base class for BoutiqueAlloy proxies.
 */
